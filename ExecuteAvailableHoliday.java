...
@DataProvider
	...
	@Test(priority=2,dataProvider="PackageData")
	  public void AvailableFactoryTest(String destination,String title, String Fname,String Sname,String title1, String Fname1,String Sname2,String MobileNo,String Email) throws Exception
	  {
		AvailablePackage avail=new AvailablePackage(driver);
		avail.AvailableHoliday(destination,title, Fname, Sname,title1, Fname1, Sname2, MobileNo, Email);
	  }
	
@DataProvider
	public Object[][] PackageData() throws Exception
	{
		Object data2[][]=excel.MyDataProvider("Sheet6",9);
		return data2;
	}
}
